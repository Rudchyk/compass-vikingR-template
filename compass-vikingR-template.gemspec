...
require './lib/compass-vikingR-template'
...
Gem::Specification.new do |s|
  ...
  s.name = "compass-vikingR-template"
  s.rubyforge_project = "compass-vikingR-template"
  # Description of your extension
  s.description = %q{A Compass implementation of Sergii Rudchyk's template}
  # A summary of your Compass extension. Should be different than Description
  s.summary = %q{Sergii Rudchyk's template}
