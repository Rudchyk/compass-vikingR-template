...
|js // Javascripts directory
    |head.min.js ->v1.0.3 // JavaScript library what make the only script in HEAD, <a href="http://headjs.com/">link</a>
    |head.min.js.map // The map file for head.min.js
    |html5.js // JavaScript adds new HTML5 elements, <a href="https://code.google.com/p/html5shiv/">link</a>
    |init.js // Adding HeadJS to the project
    |jquery.min.js ->v1.11.1 // Cross-platform JavaScript library designed to simplify the client-side scripting of HTML, <a href="http://jquery.com/">link</a>
